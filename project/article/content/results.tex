...
The only technique we used to give better results \todo[inline]{Få steps er ikke nødvendigvis bedre resultat. Kunne kalde det shorter paths, closer to optimal eller noget} was to develop the goal prioritisation technique, so the client did not fill in goals arbitrarily.
...
Note that we performed our tests on a laptop with Intel® Core™ i5 4210U Processor 2.7 GHz, 4GB DDR3L 1600 MHz SDRAM, with an SSD hard drive.\todo[inline]{Just call it SSD? or SSD storage}
