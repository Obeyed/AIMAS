...
The reason for the incrementation of the heighest score, throughout all iteratons, is to account for multiple groups of goals, for which we want to score their openings similarly.
